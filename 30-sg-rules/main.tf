...
#One backend component to another component not access directly, It will access through backend_alb only to other component for sacling and all purposes. 
